...
### 9. Avatars & Profile (`references/avatars-and-profile/`)
...
### 10. Storyboards & Sequences (`references/storyboards-and-sequences/`)
...
### 11. Grids & Collages (`references/grids-and-collages/`)
...
### 12. Branding & Packaging (`references/branding-and-packaging/`)
...
### 13. Typography & Text Layout (`references/typography-and-text-layout/`)
...
### 14. Assets & Props (`references/assets-and-props/`)
...
### 15. Academic Figures (`references/academic-figures/`)
...
### 16. Infographics (`references/infographics/`)
...
### 17. Technical Diagrams (`references/technical-diagrams/`)
